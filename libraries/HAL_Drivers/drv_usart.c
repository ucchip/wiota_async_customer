...
{
#ifdef BSP_USING_UART1
    if ((uart_obj[UART1_INDEX].serial.serial_rx != NULL) && uc_uart_get_intrxflag(uart_obj[UART1_INDEX].handle))
    {
...
int rt_hw_usart_init(void)
{
    ...
    for (int i = 0; i < obj_num; i++)
    {
        ...
        result = rt_hw_serial_register(&uart_obj[i].serial,
                                       ...
                                       RT_DEVICE_FLAG_STREAM | RT_DEVICE_FLAG_RDWR | RT_DEVICE_FLAG_INT_RX, NULL);
