...
__critical_128 void flash_write_disable_boot()
{
    WAIT_XIP_FREE;
    *reg_spi_cmd = FLASH_WD;  //set cmd
...
__critical_128 void pmc_init(void)
{
    ...
    *wdg_wiv  = 0xFFFFFFFFU - 1000 * 32768U / 1000;
    *wdg_wfd |= 0x01;
    *wdg_ctr |= 0x01;
    *wdg_wfd |= 0x01;
#endif
